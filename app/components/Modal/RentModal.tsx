...
const RentModal = () => {
    ...
    const { register, handleSubmit, watch, setValue, formState: { errors }, reset } = useForm<FieldValues>({ defaultValues: { category: '', location: null, guestCount: 1, roomCount: 1, bathroomCount: 1, imageSrc: '', price: 1, title: '', description: '' } })
    ...
    let bodyContent = (
        <div className='flex flex-col gap-8'>
            <Heading title='which of this best descripbes your place' subtitle='Pick a category' />
    ...
    if (step === STEPS.DESCRIPTION) {
        bodyContent = (
            <div className='flex flex-col gap-8'>
                ...
                <Input id='title' label='Title' disable={isLoading} register={register} errors={errors} required />
                <hr />
                <Input id='description' label='Description' disable={isLoading} register={register} errors={errors} required />
            </div>
        )
    }
    ...
    if (step === STEPS.PRICE) {
        bodyContent = (
            <div className='flex flex-col gap-8'>
                ...
                <Input id='price' label='Price' formatPrice={true} type='number' disable={isLoading} register={register} errors={errors} required />
            </div>
        )
    }
